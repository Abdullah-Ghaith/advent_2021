...
class bingo_board {
    ...
    public:
        ...
        void record_number(uint64_t number) //sets recorded num to 100, 
        {
            for (int i = 0; i<BOARD_SIZE; i++)
            {
                if (numbers[i] == number)
        ...
        bool check_win() //have to change these to 100, make 100 a def
        {
            if (numbers[0] == 100  && numbers[1] == 100 && numbers[2] == 100 && numbers[3] == 100 && numbers[4] == 100) //row #1
                {
                    competing = false;    
                    return true;
                }
            else if (numbers[5] == 100 && numbers[6] == 100 && numbers[7] == 100 && numbers[8] == 100 && numbers[9] == 100) //row #2
                {
                    competing = false;    
                    return true;
                }
            else if (numbers[10] == 100 && numbers[11] == 100 && numbers[12] == 100 && numbers[13] == 100 && numbers[14] == 100) //row #3
                {
                    competing = false;    
                    return true;
                }
            else if (numbers[15] == 100 && numbers[16] == 100 && numbers[17] == 100 && numbers[18] == 100 && numbers[19] == 100) //row #4
                {
                    competing = false;    
                    return true;
                }
            else if (numbers[20] == 100 && numbers[21] == 100 && numbers[22] == 100 && numbers[23] == 100 && numbers[24] == 100) //row #5
                {
                    competing = false;    
                    return true; 
                }

            else if (numbers[0] == 100 && numbers[5] == 100 && numbers[10] == 100 && numbers[15] == 100 && numbers[20] == 100) //col #1
                {
                    competing = false;    
                    return true;
                }
            else if (numbers[1] == 100 && numbers[6] == 100 && numbers[11] == 100 && numbers[16] == 100 && numbers[21] == 100) //col #2
                {
                    competing = false;    
                    return true;
                }
            else if (numbers[2] == 100 && numbers[7] == 100 && numbers[12] == 100 && numbers[17] == 100 && numbers[22] == 100) //col #3
                {
                    competing = false;    
                    return true;
                }
            else if (numbers[3] == 100 && numbers[8] == 100 && numbers[13] == 100 && numbers[18] == 100 && numbers[23] == 100) //col #4
                {
                    competing = false;    
                    return true;
                }
            else if (numbers[4] == 100 && numbers[9] == 100 && numbers[14] == 100 && numbers[19] == 100 && numbers[24] == 100) //col #5
                {
                    competing = false;    
                    return true;
                }
...
int main()
{
    ...
    for(int i = 0; i < num_boards; i++) //init unused sum for all boards 
    {
        bingo_boards[i].initial_unused_sum();
    }
    
    data_file.close();
    bool game_over = false;
    uint8_t winning_boards = 0;
    while(!game_over)
    {
        for(int j = 0; j < lotto_nums.size(); j++) //for every lotto number
        {
            ...
            {   
                ...
                if (bingo_boards[i].competing && bingo_boards[i].check_win())
                {
                    winning_boards++;
                }
                
                if (winning_boards == num_boards)
                {
                    game_over = true;
                }
